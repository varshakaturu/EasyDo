...
- 📅 **Reminders & Deadlines** – Set due dates and receive alerts.
- 🏷 **Categorization & Labels** – Organize tasks effectively.
...
1. **Clone the Repository:**
   ```bash
   git clone https://github.com/varshakaturu/EasyDo.git
   ```
...
## 🤝 Contributing
Contributions are welcome! If you’d like to improve EasyDo, follow these steps:
...
✨ **Stay organized, stay productive with EasyDo!** ✨
